...
for ([i, j] of [[10, 20, 30], [30, 40, 50]]){ 
    console.log(i, j) // 30과 50을 받지 못했습니다.
}

for ([i, j, ...k] of [[10, 20, 30, 1, 2], [30, 40, 50, 1]]){ // 몇 개 들어올지 모르는 경우
    console.log(i, j, k) // 30과 50을 받지 못했습니다.
}
...
let [a, b, c] = [data[0], [data[1], data[2], data[3]], data[4]]; // O
